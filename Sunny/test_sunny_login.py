...
def load_challenge(username):                   # Load the challenges from quizz file
    import test_sunny_testfile               # Import the challenges from our quizz file
    app = test_sunny_testfile.QuizApp(root, username)  # Create an instance of QuizApp with our challenges
