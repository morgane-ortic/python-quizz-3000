...
# Create some houses
houses = [                      # We add 9px to starting x and substract 18px to rectangle width to make it look good with player sprite
    # Inn
    House(387, 66, 616, 291),
    House(537, 359, 318, 97),

    # shop
    House(243, 551, 330, 243),
    House(243, 841, 180, 79),
    House(489, 841, 84, 79),
    House(243, 794, 1, 48),
    House(530, 794, 43, 48),
    House(261, 758, 153, 47),

    # stables
    House(1159, 286, 126, 167),

    # small house
    House(777, 575, 222, 217),
    House(935, 792, 64, 30),
]
...
man = player(676, 470, 48, 60)          # Starting position and size of player
shootLoop = 0
run = True
while run:
    clock.tick(30)
    ...
    if keys[pygame.K_LEFT] and man.x > man.vel:
        new_x -= man.vel
    elif keys[pygame.K_RIGHT] and man.x < 1536 - man.width - man.vel:
        new_x += man.vel
    ...
    player_rect = pygame.Rect(new_x, new_y + 42, man.width, man.height - 42)
